...
const contentSecurityPolicy = [
  "default-src 'self'",
  // unsafe-eval: YouTube IFrame API (and some Next runtime paths) use eval
  ...
  "connect-src 'self' https: https://www.youtube.com https://www.googleapis.com https://login.microsoftonline.com https://graph.microsoft.com",
  "font-src 'self' data:",
  "object-src 'none'",
  "base-uri 'self'",
